...
import workoutsInstructionsPathId from "./routes/instructions-id/openApiRouteWorkoutsInstructions";
import workoutsInstructionsPathIdLevel from "./routes/instructions-id-level/openApiRouteWorkoutsInstructions";
