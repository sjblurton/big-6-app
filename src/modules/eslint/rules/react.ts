export const reactRules = {
    rules: {
        ...
        /**
         * Enforce the use of `React` hooks.
         *
         * 🔧 Fixable - https://react.dev/reference/rules/rules-of-hooks
         */
        ...
        /**
         * Enforce the use of `React` tsx.
         *
         * 🔧 Fixable - https://github.com/jsx-eslint/eslint-plugin-react/blob/master/docs/rules/jsx-filename-extension.md
         */
