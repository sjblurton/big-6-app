...
jest.mock("../Breadcrumbs/Breadcrumbs.tsx", () => {
...
describe("Form", () => {
    ...
    it("should throw an error when mutation fails", async () => {
        ...
        expect(() => render(<CreateForm />)).toThrow("Mutation failed")
    })
})
